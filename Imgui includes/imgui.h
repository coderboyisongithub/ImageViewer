...
namespace ImGui
{
	...
	//user change..
	IMGUI_API void Textview(ImGuiID id,const char *text_Data,float allocation_pCentage=0.5,bool tool_tip=true,bool yaligin=false,bool xaligin=true);
	...
	//IMGUI_API void          RenderFrame(ImVec2 p_min, ImVec2 p_max, ImU32 fill_col, bool border, float rounding); //User edit 09/06/2018 render rectangular frame
    // Styles
